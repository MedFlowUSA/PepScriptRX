...
const storefronts = [
  ...
  { path: '/EHWSUB', label: 'Radiance legacy route', brand: 'Radiance', checkoutScope: null },
  { path: '/ehwsub', label: 'Radiance legacy route (lowercase)', brand: 'Radiance', checkoutScope: null },
