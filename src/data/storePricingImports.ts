...
export const OPTIMAX_PRICING_IMPORT_ROWS: StorePricingImportRow[] = [
  ...
  { product_slug: 'optimax-hgh-somatropin', product_name: 'HGH / Somatropin', category: 'Recovery / Performance / Wellness', retail_price: 285, display_price: 285, is_active: true, image_path: OPTIMAX_PRODUCT_IMAGE_PATH, admin_code: OPTIMAX_ADMIN_CODE, store_slug: OPTIMAX_STORE_SLUG },
