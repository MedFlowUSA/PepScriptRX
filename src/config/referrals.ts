...
export const REP_PORTALS: RepPortal[] = [
  ...
  },
  {
    path: '/auroraJL',
    repSlug: 'AURORAJL',
    discountCode: 'AURORAJL',
    repName: 'Jermaine Lusk',
    manifest: '/manifests/aurora.webmanifest',
  },
  {
    path: '/auroraMD',
  ...
  },
  {
    path: '/auroraET',
    repSlug: 'AURORAET',
    discountCode: 'AURORAET',
    repName: 'Edwiena L Thompson',
    manifest: '/manifests/aurora.webmanifest',
  },
  {
    path: '/auroraTO',
    repSlug: 'AURORATO',
    discountCode: 'AURORATO',
    repName: 'Thomas KeJohnna Owens',
    manifest: '/manifests/aurora.webmanifest',
  },
  {
    path: '/auroraGE',
    repSlug: 'AURORAGE',
    discountCode: 'AURORAGE',
    repName: 'Gabriela Espinoza',
    manifest: '/manifests/aurora.webmanifest',
  },
  {
    path: '/aurora/McCall',
    repSlug: 'AURORARM',
    discountCode: 'AURORARM',
    repName: 'Ray McCalll',
    manifest: '/manifests/aurora.webmanifest',
  },
  {
    path: '/auroraEW',
    repSlug: 'AURORAEW',
    discountCode: 'AURORAEW',
    repName: 'Ebony Williams',
    manifest: '/manifests/aurora.webmanifest',
  },
  {
