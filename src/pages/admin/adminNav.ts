export const ADMIN_NAV = [
  ...
  { label: 'Rep Intake', path: '/admin/rep-intake', icon: '09' },
  { label: 'Reps', path: '/admin/reps', icon: '10' },
  { label: 'Payouts', path: '/admin/payouts', icon: '11' },
  { label: 'Scope Codes', path: '/admin/scope-codes', icon: '12' },
  { label: 'PayPal Audit', path: '/admin/payment-audit', icon: '13' },
  { label: 'Fulfillment', path: '/admin/fulfillment', icon: '14' },
];
