    ...
    <PublicLayout>
      <div style={{ minHeight: '70vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '80px 24px' }}>
        <div style={{ maxWidth: 560, textAlign: 'center' }}>
          <div style={{ width: 72, height: 72, borderRadius: '50%', background: 'var(--success-bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 24px', fontSize: 32 }}>
            ✓
          </div>
          ...
          <p style={{ fontSize: 17, color: 'var(--text-muted)', lineHeight: 1.7, marginBottom: 32 }}>
            Our team will review your receipt and prescription attestation, then contact you with available refill options. Most reviews are completed within 1-2 business days.
          </p>
          ...
          <div className="disclaimer" style={{ marginBottom: 32 }}>
            PepScriptRX does not guarantee approval or savings. Eligibility depends on prescription verification, state availability, and fulfillment partner review.
          </div>
