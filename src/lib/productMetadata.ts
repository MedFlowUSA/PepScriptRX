...
const PRODUCT_METADATA_ENTRIES: Array<ProductMetadata & { keys: string[] }> = [
  ...
  product(['hgh-15iu', 'hgh 15 iu', 'hgh-36iu', 'hgh 36 iu'], 'HGH / Somatropin', 'Somatropin', '10 IU x 10, 100 IU total'),
  product(['hgh-somatropin', 'hgh / somatropin', 'hgh'], 'HGH / Somatropin', 'Somatropin', '10 IU x 10, 100 IU total'),
